...
PRACTICE_HERO = {
    "land-use-zoning": "hero-skylines.jpg",
    "real-property-litigation": "courthouse-columns.jpg",
    "real-estate-transactions": "townhomes.jpg",
    "eminent-domain": None,
    "historic-preservation": None,
    "real-estate-taxation": None,
    "local-counsel": "office-conference.jpg",
}

# ---------------------------------------------------------------- results
# Only verified matters. Each: slug, title, meta (place/year), summary, practices (slugs), featured
RESULTS = [
    dict(slug="hyde-park-square", title="Hyde Park Square rezoning", meta="Cincinnati · 2024–2025",
    ...
    dict(slug="washington-park-bell-tower", title="Saving the Washington Park bell tower", meta="Over-the-Rhine · 2022–2023",
    ...
    dict(slug="crosley-building", title="Crosley Building adaptive reuse", meta="Camp Washington · 2020–2021",
    ...
    dict(slug="st-vincent-de-paul", title="St. Vincent de Paul outreach center", meta="West End · 2018",
         ...
         practices=["land-use-zoning"]),
    dict(slug="pendleton-senior-housing", title="Affordable senior housing in the historic urban core", meta="Pendleton, Cincinnati · 2026",
         kicker="Entitlements",
    ...
    dict(slug="miller-v-cincinnati", title="Taxpayer standing: Cincinnati ex rel. Miller v. Cincinnati", meta="2024-Ohio-4805 (1st Dist.)",
    ...
    dict(slug="cook-v-lockland", title="Nonconforming uses: Cook v. Lockland", meta="2024-Ohio-9 (1st Dist.)",
         kicker="Published opinion",
    ...
    dict(slug="mt-lookout", title="Use variances: Mt. Lookout Community Council v. Cincinnati", meta="2023-Ohio-1729 (1st Dist.)",
         kicker="Published opinion",
    ...
    dict(slug="kroger-tower", title="Grocery-anchored downtown tower", meta="Downtown Cincinnati · 2018",
    ...
    dict(slug="millennium-hotel", title="Convention hotel acquisition", meta="Downtown Cincinnati · 2020",
         kicker="Acquisition",
    ...
    dict(slug="assisted-living-portfolio", title="$100 million assisted living portfolio", meta="Ohio, Kentucky, and Indiana · 2020",
         kicker="Sale-leaseback financing",
    ...
    dict(slug="orthodontics-leases", title="Retail leasing program for a growing orthodontics group", meta="Greater Cincinnati and Northern Kentucky · 2019",
         ...
         practices=["real-estate-transactions"]),
    dict(slug="playhouse-square-tower", title="Playhouse Square residential tower", meta="Downtown Cleveland · opened 2020",
         ...
         practices=["real-estate-transactions", "local-counsel"]),
    dict(slug="w-austin", title="W Austin Hotel & Residences condominium", meta="Austin, Texas",
         ...
         practices=["real-estate-transactions"], featured=True),
    dict(slug="the-grove", title="The Grove: 75 acres of state land into a walkable mixed-use community", meta="Austin, Texas",
         ...
         practices=["real-estate-transactions"]),
    dict(slug="barton-creek-mueller", title="Austin's marquee master-planned communities", meta="Barton Creek and Mueller · Austin, Texas",
